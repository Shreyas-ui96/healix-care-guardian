...
class DiseasePredictor:
    ...
    def _suggest_follow_up_question(self, recognized: List[str], top_diseases: List[str]) -> Optional[dict]:
    ...
    def predict(self, symptoms: List[str], top_k: int = 3) -> dict:
        ...
        if not diagnosis_available or top_tier != "high":
            follow_up = self._suggest_follow_up_question(recognized, top_diseases)
